    ...
    return (
        <main>
            ...
            {started ? (
                ...
                {
                    finished === true ? (
                        <Roulette participants={participants} minRollDuration={minRouletteDuration} maxRollDuration={maxRouletteDuration}/>
                    ) : (
                        <div className="bg-white pt-5 pb-5 pl-7 pr-7 mt-7 rounded-xl drop-shadow-xl flex flex-col justify-center w-2/5 sm:w-4/5">
